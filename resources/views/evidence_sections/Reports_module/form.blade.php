    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                value="{{ old('customer_name', $reports_modules->customer_name)}}">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                value="{{ old('assigned_attomey', $reports_modules->assigned_attomey)}}">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                value="{{ old('status_case', $reports_modules->status_case)}}">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                value="{{ old('date_writting', $reports_modules->date_writting)}}">
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <select name="type_report" id="type_report" class="form-control">
                    ...
                    <option value="Activo" {{ old('type_report', $reports_modules->type_report ?? '') == 'Activo' ? 'selected' : '' }}>Activo</option>
                    <option value="Cerrado" {{ old('type_report', $reports_modules->type_report ?? '') == 'Cerrado' ? 'selected' : '' }}>Cerrado</option>
                    <option value="En proceso" {{ old('type_report', $reports_modules->type_report ?? '') == 'En proceso' ? 'selected' : '' }}>En proceso</option>
                </select>
            </div>
        </div>
    </div>
